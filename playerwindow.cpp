...
PlayerWindow::PlayerWindow(QWidget *parent) : QWidget(parent)
{
	...
	connect(m_slider, SIGNAL(sliderMoved(int)), this, SLOT(seekBySlider(int)));
	connect(m_slider, SIGNAL(sliderPressed()), this, SLOT(seekBySlider()));
	connect(m_player, SIGNAL(positionChanged(qint64)), this, SLOT(updateSlider(qint64)));
	connect(m_player, SIGNAL(started()), this, SLOT(updateSlider()));
	connect(m_player, SIGNAL(notifyIntervalChanged()), this, SLOT(updateSliderUnit()));
	...
	connect(m_openBtn, SIGNAL(clicked()), this, SLOT(openMedia()));
	connect(m_playBtn, SIGNAL(clicked()), this, SLOT(playPause()));
